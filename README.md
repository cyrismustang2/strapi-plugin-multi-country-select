...
```
# Using Yarn
yarn add @cyrismustang/strapi-plugin-multi-country-select

# Or using NPM
npm install @cyrismustang/strapi-plugin-multi-country-select
```
...
- Forked and modified from [strapi-plugin-multi-country-select](https://github.com/Zaydme/strapi-plugin-multi-country-select)